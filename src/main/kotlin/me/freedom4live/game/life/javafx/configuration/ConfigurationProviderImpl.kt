...
import me.freedom4live.game.life.javafx.configuration.spring.TimingConfiguration
...
class ConfigurationProviderImpl(private val objectsConfiguration: ObjectsConfiguration,
                                private val windowConfiguration: WindowConfiguration,
                                private val timingConfiguration: TimingConfiguration) : ConfigurationProvider {
    ...
    override fun frameTimerMilliSeconds(): Int = timingConfiguration.frameSchedule.toInt()

    override fun initCellAliveProbabilityPercents(): Int = objectsConfiguration.initCellAlivePercentage.toInt()
